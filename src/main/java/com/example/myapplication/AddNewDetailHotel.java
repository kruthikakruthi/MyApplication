...
public class AddNewDetailHotel extends AppCompatActivity {
    ...
    final  LoadingDialog loadingDialog=new LoadingDialog(AddNewDetailHotel.this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.admin_add_new_detail_hotel);

        Toast.makeText(AddNewDetailHotel.this, "welcome admin", Toast.LENGTH_SHORT).show();

        CategoryName= getIntent().getExtras().get("category").toString();
        Imageref= FirebaseStorage.getInstance().getReference().child("Hotel Images");
        DetailRef= FirebaseDatabase.getInstance().getReference().child("stay");

        Addnewdetail=findViewById(R.id.add_new_hotel);
        InputImage=findViewById(R.id.hotel_d_image);
        InputDescription=findViewById(R.id.hotel_d_description);
        InputName=findViewById(R.id.hotel_d_name);
        InputAddress=findViewById(R.id.hotel_d_address);
        InputPrice=findViewById(R.id.hotel_d_price);
    ...
    private  void ValidateProductData()
    {
        ...
        {
            Toast.makeText(this, "please give the Address", Toast.LENGTH_SHORT).show();
        }
    ...
    private void StoreImageInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(AddNewDetailHotel.this, "Error:"+message, Toast.LENGTH_SHORT).show();
                //loadingBar.dismiss();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                loadingDialog.dismissDialog();
                Toast.makeText(AddNewDetailHotel.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    private void SaveInfoToDatabase() {
        ...
        DetailMap.put("himage",downloadImageUrl);
        DetailMap.put("category",CategoryName);
        DetailMap.put("haddress",Address);
        DetailMap.put("hname",Dname);
        DetailMap.put("hprice",Price);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            Intent intent= new Intent(AddNewDetailHotel.this,AdminCategoryActivity.class);
                            startActivity(intent);
                            finish();
                            loadingDialog.dismissDialog();
                            Toast.makeText(AddNewDetailHotel.this,"details has been stored to databse successfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            //loadingBar.dismiss();
